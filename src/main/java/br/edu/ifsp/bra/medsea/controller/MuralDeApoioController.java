...
public class MuralDeApoioController {
    ...
    // Método GET para obter todos os comentários de um mural específico
    ...
    public ResponseEntity<MuralDeApoio> updateMural(@PathVariable int id, @RequestBody MuralDeApoio muralAtualizado) {
        ...
        if (muralExistente.isPresent()) {
            ...
            mural.setConteudoComentario(muralAtualizado.getConteudoComentario());  // Assumindo que MuralDeApoio tem um campo 'descricao'
    ...
    public ResponseEntity<MuralDeApoio> createNewComentario(@PathVariable int muralId, @RequestBody Comentario newComentario) {
        ...
        if (muralOpt.isPresent()) {
            ...
            MuralDeApoio updatedMural = muralDeApoioRepo.save(mural);
            newComentario.setMuralDeApoio(updatedMural);
            return ResponseEntity.status(HttpStatus.CREATED).body(updatedMural);
        } else {
